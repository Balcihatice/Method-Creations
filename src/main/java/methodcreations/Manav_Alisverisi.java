...
public class Manav_Alisverisi {
    ...
    static List<String> urunListesi = new ArrayList<>(Arrays.asList("patates - urun kodu : 1",
            "limon - urun kodu : 2", "kivi - urun kodu : 3",
            "biber - urun kodu : 4", "patlican - urun kodu : 5"));
    //urunlerin atanacagi bos list ve diger methodlarda da kullanabilmek icin instance yaptik.
    static List<Double> urunFiyatlari = new ArrayList<>(Arrays.asList(5.0, 7.5, 1.3, 8.7, 9.2));
    //urun fiyatlarinin atanacagi bos list ve instance variable.
    ...
    private static void musteriSecim() {
        ...
        //urun listesi 1'den 5'e kadar. Or. musteri 5. urunu secti, fiyatina ulasmak icin 4. index'e gitmek lazim.
